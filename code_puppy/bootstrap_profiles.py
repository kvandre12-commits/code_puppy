...
_BUILTIN_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "android-termux-lean": {
        ...
        "extras": [],
        "notes": [
            "Install the Termux build toolchain first; pydantic-core has no Android wheel.",
...
def build_install_plan(
    *,
    ...
    if resolved_profile == "android-termux-lean" and not environment.get("has_rust"):
        missing_system_packages.append("rust")
    if resolved_profile == "android-termux-lean" and not environment.get("has_clang"):
        missing_system_packages.append("clang")
