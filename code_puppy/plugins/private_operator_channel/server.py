    ...
    class PrivateOperatorRequestHandler(BaseHTTPRequestHandler):
        ...
        def do_POST(self) -> None:  # noqa: N802
            ...
            try:
                ...
                self._write_json(400, {"success": False, "error": "invalid_content_length"})
                return
            ...
            if not isinstance(payload, dict):
                self._write_json(400, {"success": False, "error": "payload_must_be_object"})
                return
...
def serve(
    *,
    ...
    config, resolved_path, config_exists = load_private_operator_channel_config(config_path)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the private operator channel server.")
