...
* **P1 - durable project notes**: drawers in ``repo:<cwd>`` with
  ...
  Principles, facts, decisions, artifacts, relationships, and history live here
  until typed drawers are modeled explicitly. Highest signal-to-token ratio in the kennel.
