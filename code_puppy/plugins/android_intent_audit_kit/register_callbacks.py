...
from .tooling import (
    android_intent_audit_app as android_intent_audit_app_impl,
    android_intent_audit_doctor as android_intent_audit_doctor_impl,
    android_intent_audit_examples as android_intent_audit_examples_impl,
    android_intent_audit_stack as android_intent_audit_stack_impl,
)

_DOCTOR = "android_intent_audit_doctor"
_APP = "android_intent_audit_app"
_STACK = "android_intent_audit_stack"
...
def register_android_intent_audit_app(agent: Any) -> None:
    @agent.tool
    async def android_intent_audit_app(
        context: RunContext,
        package_name: str,
        ...
        del context
        return android_intent_audit_app_impl(
...
def register_android_intent_audit_stack(agent: Any) -> None:
    ...
    async def android_intent_audit_stack(
        ...
        del context
        return android_intent_audit_stack_impl(
...
def register_tools_callback() -> list[dict[str, Any]]:
    return [
        {"name": _DOCTOR, "register_func": register_android_intent_audit_doctor},
        {"name": _APP, "register_func": register_android_intent_audit_app},
