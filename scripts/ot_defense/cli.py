...
from scripts.ot_defense.core import (
    TargetParseError,
    parse_ports,
    parse_target_tokens,
    render_markdown,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--target-file",
        type=Path,
        help="File containing authorized IPv4 targets/CIDRs, one per line or comma separated.",
    )
    parser.add_argument(
        "--ports",
        default="default",
        help="Comma-separated TCP ports, or 'default' for risky OT/remote-access ports.",
    )
    parser.add_argument(
